---
title: Complete Guide to Setting Up Node js Express Project with TypeScript
draft: false
pubDate: 2024-08-04
...
author: "Mohammed"
image: "./images/student-attending-school.jpg"
...
> For a complete starter template, you can check out my 📁 [`express-typescript-starter`](https://github.com/mohxmd/express-typescript-starter) repository on GitHub. It includes the basic setup and structure for building a scalable and maintainable Node.js application with Express, TypeScript, and MongoDB.
