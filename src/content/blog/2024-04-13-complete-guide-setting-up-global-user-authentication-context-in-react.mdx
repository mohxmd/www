...
author: "Mohammed"
image: "./images/security-digital-art.jpg"
tags: ["react"]
---
...
export const ContextProvider = ({ children }) => {
  ...
  return (
    <StateContext.Provider value={{ userData, updateUserData }}>{children}</StateContext.Provider>
  );
};
...
[Check out the MERN Blogging Website project on GitHub](https://github.com/mohxmd/mern-blogging-website)
