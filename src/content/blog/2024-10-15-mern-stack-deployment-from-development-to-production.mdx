...
author: "Mohammed"
image: "./images/truck-with-mern-payload.png"
...
```bash
curl -o deploy.sh https://gist.githubusercontent.com/mohxmd/5a18d763a92b8ad8eb08f9a74cc7625a/raw/be7448bbbfd0992f82673386a868d25b4cecbbb9/deploy.sh
```
